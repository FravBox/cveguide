...
- [ ] **Discohook messages?**<br>
Have you gotten familiar with how [Discohook](https://discohook.app) works? Did you want to use the bot? Have you come up with a unified way you want your messages to look? Did you need to set up any [button flows](https://discohook.app/guide/getting-started/flows)?<br>
- [ ] **First channel messages?**<br>
Did you make the first messages for each channel (and optionally pin them)?<br>
...
- [ ] **Event rules/info are posted somewhere?**<br>
